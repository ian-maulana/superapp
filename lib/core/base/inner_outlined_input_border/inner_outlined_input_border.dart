...
class InnerOutlinedInputBorder extends InputBorder {
  ...
  ///    drawn.
  const InnerOutlinedInputBorder({
  ...
  @override
  InnerOutlinedInputBorder copyWith({
  ...
  @override
  InnerOutlinedInputBorder scale(double t) {
    return InnerOutlinedInputBorder(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is InnerOutlinedInputBorder) {
      final InnerOutlinedInputBorder outline = a;
      return InnerOutlinedInputBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is InnerOutlinedInputBorder) {
      final InnerOutlinedInputBorder outline = b;
      return InnerOutlinedInputBorder(
  ...
  bool operator ==(Object other) {
    ...
    return other is InnerOutlinedInputBorder &&
...
abstract class MaterialStateOutlinedInputBorder extends InnerOutlinedInputBorder
